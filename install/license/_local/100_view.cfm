<!--- this file presents the user with the license for the plugin --->
...
<cf_html parent="#pluginmanager.view.main#"><cfoutput>
	<div xmlns:tap="xml.tapogee.com">
		...
		<div style="text-align:center; width: 600px;">
			<form method="get" action="#htmleditformat(getLib().getURL('','C'))#" tap:features="false" style="display:inline;">
