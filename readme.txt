...
LICENSE 
----------------------------------------------- 
The onTap framework and the ColdBox Importer plugin 
...
Plugin Manager tool to install the ColdBox Importer plugin 
by navigating to http://[ontap]/admin/plugins and 
selecting the New Plugins tab. Locate the ColdBox Importer 
...
The root /coldbox/ directory in the zip archive should 
be directly underneath the plugin source directory, i.e. 
[ontap]/_tap/admin/plugins/source/coldbox 
